...
```{r include=FALSE}
file.copy('../generate_single_cell_data/lm_glycogene_pseudopresence.Rds', 'lm_glycogene_pseudopresence.Rds')
...
file.copy('../generate_single_cell_data/lm_chromium10x_mupb_norm_nziqr_threshold_cutoff.Rds', 'lm_chromium10x_mupb_norm_nziqr_threshold_cutoff.Rds')
...
```{r}
file.copy('../generate_single_cell_data/seg_lookup.Rds', 'seg_lookup.Rds')
segs = unique(names(readRDS('seg_lookup.Rds')))
file.remove('seg_lookup.Rds')

file.copy('../generate_single_cell_data/mouse_orthology_human_genes.tsv', 'mouse_orthology_human_genes.tsv')
...
file.copy('../generate_single_cell_data/glycogenes.tsv', 'glycogenes.tsv')
...
file.copy('../generate_bulk_data/tissue_results_log.Rds', 'tissue_results_log.Rds')
...
file.copy('../generate_bulk_data/tissue_results_log_tcga.Rds', 'tissue_results_log_tcga.Rds')
...
file.copy('../generate_single_cell_data/pseudobulk_log_seg_norm.Rds', 'pseudobulk_log_seg_norm.Rds')
...
file.copy('../generate_single_cell_data/alldata_clean_human_clr_sparse.Rds', 'alldata_clean_human_clr_sparse.Rds')
...
file.copy('../generate_single_cell_data/alldata_clean_mouse_clr_sparse.Rds', 'alldata_clean_mouse_clr_sparse.Rds')
...
file.copy('../generate_single_cell_data/glycogene_mouse_panglaodb_pseudobulkpresence.Rds', 'glycogene_mouse_panglaodb_pseudobulkpresence.Rds')
