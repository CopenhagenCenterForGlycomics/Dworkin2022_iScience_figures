...
```{r include=FALSE}
file.copy('../generate_single_cell_data/lm_glycogene_pseudopresence.Rds', getwd())
...
file.copy('../generate_single_cell_data/lm_chromium10x_mupb_norm_nziqr_threshold_cutoff.Rds', getwd())
...
```{r}
file.copy('../generate_single_cell_data/seg_lookup.Rds', getwd())
segs = unique(names(readRDS('seg_lookup.Rds')))
file.remove('seg_lookup.Rds')

file.copy('../generate_single_cell_data/mouse_orthology_human_genes.tsv', getwd())
...
file.copy('../generate_single_cell_data/glycogenes.tsv', getwd())
...
file.copy('../generate_bulk_data/tissue_results_log.Rds', getwd())
...
file.copy('../generate_bulk_data/tissue_results_log_tcga.Rds', getwd())
...
file.copy('../generate_single_cell_data/pseudobulk_log_seg_norm.Rds', getwd())
...
file.copy('../generate_single_cell_data/alldata_clean_human_clr_sparse.Rds', getwd())
...
file.copy('../generate_single_cell_data/alldata_clean_mouse_clr_sparse.Rds', getwd())
...
file.copy('../generate_single_cell_data/glycogene_mouse_panglaodb_pseudobulkpresence.Rds', getwd())
