...
```{r load_datasets_mouse, cache=F, include=FALSE, eval=!file.exists('alldata_clean_mouse_clr_sparse.Rds')}
...
```{r include=FALSE, eval=!file.exists('alldata_clean_mouse_clr_sparse.Rds')}
alldata=list()
attributes(alldata)$clustersize = c(attributes(alldata_clean_mouse)$clustersize) 
```

```{r eval=!file.exists('alldata_clean_mouse_clr_sparse.Rds')}
...
```{r include=!file.exists('alldata_clean_mouse_clr_sparse.Rds'), eval=!file.exists('alldata_clean_mouse_clr_sparse.Rds')}
...
```{r load_datasets_human, cache=F, include=FALSE, eval=!file.exists('alldata_clean_human_clr_sparse.Rds')}
...
```{r eval=!file.exists('alldata_clean_human_clr_sparse.Rds')}
attributes(alldata)$thresholds = sapply(attributes(alldata)$clustersize,compute_threshold)
```

```{r include=FALSE, eval=!file.exists('alldata_clean_human_clr_sparse.Rds')}
required_genes=c('DPAGT1','ALG2')
...
```{r include=!file.exists('alldata_clean_human_clr_sparse.Rds'), eval=!file.exists('alldata_clean_human_clr_sparse.Rds')}
