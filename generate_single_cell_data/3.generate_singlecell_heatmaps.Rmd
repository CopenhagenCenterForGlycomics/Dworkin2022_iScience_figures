...
```{r sc_heatmap}
knoter::excel(sc_heatmap_high_clr=heatmap_data_high_clr,raw_data_high_clr=high_clr_expression_heatmap_data, sc_heatmap_non_stable=heatmap_data_non_stable,raw_data_non_stable=non_stable_expression_heatmap_data)
```
